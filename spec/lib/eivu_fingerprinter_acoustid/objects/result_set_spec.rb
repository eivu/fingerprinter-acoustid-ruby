...
describe EivuFingerprinterAcoustid::Objects::ResultSet do
  ...
  describe "best match" do
    ...
    context "weird - Ella & Louis - Willow Weep" do
      ...
      it "parses the hash successfully" do
        aggregate_failures do
          ...
          expect(best_match).to be_kind_of(EivuFingerprinterAcoustid::Objects::Match)
          expect(best_match.release_group).to be_kind_of(EivuFingerprinterAcoustid::Objects::ReleaseGroup)
          expect(best_match.recording).to be_kind_of(EivuFingerprinterAcoustid::Objects::Recording)
        end
      end
    end
    ...
    context "found via substring" do
      ...
      let(:offset) { EivuFingerprinterAcoustid::Objects::Match::OFFSET_IN_STRING }
      ...
      it "parses the hash successfully" do
        aggregate_failures do
          ...
          expect(best_match.distance).to eq(EivuFingerprinterAcoustid::Objects::Match::THRESHOLD_MIN + offset)
          expect(best_match.release_group).to be_kind_of(EivuFingerprinterAcoustid::Objects::ReleaseGroup)
          expect(best_match.recording).to be_kind_of(EivuFingerprinterAcoustid::Objects::Recording)
        end
      end
    ...
    context "found via reordering" do
      ...
      let(:offset) { EivuFingerprinterAcoustid::Objects::Match::OFFSET_REORDERED }
