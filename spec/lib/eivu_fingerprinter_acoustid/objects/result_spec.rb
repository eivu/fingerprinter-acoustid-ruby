...
describe EivuFingerprinterAcoustid::Objects::Result do
  describe "#new" do
  ...
  describe "#generate_match" do
    ...
    it "returns the best recording " do
      aggregate_failures do
        expect(match).to be_kind_of(EivuFingerprinterAcoustid::Objects::Match)
        expect(match.release_group).to be_kind_of(EivuFingerprinterAcoustid::Objects::ReleaseGroup)
        expect(match.recording).to be_kind_of(EivuFingerprinterAcoustid::Objects::Recording)
